...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-background text-brand-primary">
      <header className="border-b border-brand-accent/50 bg-brand-card/80 backdrop-blur-sm sticky top-0 z-10"><div className="container mx-auto px-4 py-4 flex items-center justify-between"><h1 className="text-2xl md:text-3xl font-bold text-brand-primary">Painel Administrativo</h1><Button onClick={handleLogout} variant="outline" className="gap-2"><LogOut className="h-4 w-4" />Sair</Button></div></header>
